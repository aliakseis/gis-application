...
typedef enum { SWQ_INTEGER, SWQ_FLOAT, SWQ_STRING, SWQ_BOOLEAN, SWQ_OTHER } swq_field_type;
...
const char *swq_expr_compile(const char *where_clause, int field_count, char **field_names,
                             swq_field_type *field_types, swq_expr **expr);
...
const char *swq_select_preparse(const char *select_statement, swq_select **select_info);
